...
configure_routing(){
  ...
  run_remote $NODE_1 "ipfs swarm peers"
  run_remote $NODE_2 "ipfs swarm peers"
  run_remote $NODE_3 "ipfs swarm peers"
}
...
get_stats r_gpl_n1_pre $NODE_1
get_stats r_gpl_n2_pre $NODE_2
get_stats r_gpl_n3_pre $NODE_3

get_pinned_local

get_stats r_gpl_n1_post $NODE_1
get_stats r_gpl_n2_post $NODE_2
get_stats r_gpl_n3_post $NODE_3
